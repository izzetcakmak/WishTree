...
const translations = {
  ...
  'agents.active': { tr: 'Aktif', en: 'Active' },
  ...
  'finance.swapQcadHint': { tr: 'QCAD swapları için StableFX sekmesini kullanın (kurumsal RFQ)', en: 'For QCAD swaps use the StableFX tab (institutional RFQ)' },
  ...
  // StableFX
  'finance.sfxDesc': { tr: 'Circle StableFX ile kurumsal düzeyde stablecoin FX takası — FxEscrow üzerinde PvP atomik settlement', en: 'Institutional-grade stablecoin FX swap via Circle StableFX — PvP atomic settlement on FxEscrow' },
  'finance.sfxPair': { tr: 'Döviz Çifti', en: 'Currency Pair' },
  'finance.sfxMinAmount': { tr: 'Minimum tutar: 10', en: 'Minimum amount: 10' },
  'finance.sfxMinLabel': { tr: 'Min.', en: 'Min.' },
  'finance.sfxExecute': { tr: 'FX Takası Yap', en: 'Execute FX Swap' },
  'finance.sfxExecuting': { tr: 'İşlem yapılıyor...', en: 'Executing...' },
  'finance.sfxNewTrade': { tr: 'Yeni İşlem', en: 'New Trade' },
  'finance.sfxRetry': { tr: 'Tekrar Dene', en: 'Retry' },
  'finance.sfxQuoteDetails': { tr: 'Teklif Detayları', en: 'Quote Details' },
  'finance.sfxRate': { tr: 'Kur', en: 'Rate' },
  'finance.sfxYouSell': { tr: 'Satıyorsunuz', en: 'You Sell' },
  'finance.sfxYouGet': { tr: 'Alıyorsunuz', en: 'You Get' },
  'finance.sfxFee': { tr: 'Ücret', en: 'Fee' },
  'finance.sfxExpiry': { tr: 'Süre Sonu', en: 'Expiry' },
  'finance.sfxStepPermit2': { tr: 'Permit2 onayı kontrol ediliyor...', en: 'Checking Permit2 approval...' },
  'finance.sfxStepQuote': { tr: 'Teklif isteniyor...', en: 'Requesting quote...' },
  'finance.sfxStepTrade': { tr: 'İşlem oluşturuluyor...', en: 'Creating trade...' },
  'finance.sfxStepSign': { tr: 'İşlem niyeti imzalanıyor (EIP-712)...', en: 'Signing trade intent (EIP-712)...' },
  'finance.sfxStepFund': { tr: 'Fonlama imzalanıyor (Permit2)...', en: 'Signing funding (Permit2)...' },
  'finance.sfxStepSettle': { tr: 'On-chain settlement bekleniyor...', en: 'Awaiting on-chain settlement...' },
  'finance.sfxApproved': { tr: 'onaylandı', en: 'approved' },
  'finance.sfxQuoteRate': { tr: 'Kur', en: 'Rate' },
  'finance.sfxTradeLocked': { tr: 'İşlem kilitlendi', en: 'Trade locked' },
  'finance.sfxSigned': { tr: 'İmza onaylandı', en: 'Signature confirmed' },
  'finance.sfxFunded': { tr: 'Fonlama tamamlandı', en: 'Funding completed' },
  'finance.sfxSettled': { tr: 'Settlement tamamlandı', en: 'Settlement complete' },
  'finance.sfxSettling': { tr: 'Settlement devam ediyor — ArcScan\'dan takip edebilirsiniz', en: 'Settlement in progress — check ArcScan' },
  'finance.sfxHowItWorks': { tr: 'Nasıl Çalışır?', en: 'How It Works' },
  'finance.sfxInfo1': { tr: '🔄 StableFX, Circle\'ın kurumsal düzeyde RFQ (Request-for-Quote) FX motorudur. Birden fazla likidite sağlayıcısından rekabetçi kurlar sunar.', en: '🔄 StableFX is Circle\'s institutional-grade RFQ FX engine. It aggregates competitive rates from multiple liquidity providers.' },
  'finance.sfxInfo2': { tr: '🔐 FxEscrow akıllı kontratı üzerinden PvP (Payment-versus-Payment) atomik settlement sağlar — iki taraf da aynı anda settle eder veya hiç settle etmez.', en: '🔐 Ensures PvP (Payment-versus-Payment) atomic settlement via FxEscrow smart contract — both sides settle simultaneously or not at all.' },
  'finance.sfxInfo3': { tr: '⚡ Permit2 + EIP-712 imza tabanlı güvenli transfer — approve sadece bir kez gerekir.', en: '⚡ Secure transfer via Permit2 + EIP-712 signatures — approval only needed once.' },
  ...
  'bless.registering': { tr: 'Dilek on-chain kaydediliyor...', en: 'Registering wish on-chain...' },
  ...
  'agent.creating': { tr: 'Ajan oluşturuluyor ve on-chain kaydediliyor...', en: 'Creating agent & registering on-chain...' },
