...
export default class ErrorBoundary extends Component<Props, State> {
  ...
  static getDerivedStateFromError(error: Error): State {
    return { hasError: true, error: error?.message || 'Beklenmeyen bir hata oluştu' };
  }
        ...
        <div className="flex flex-col items-center justify-center min-h-[300px] p-8">
          <div className="p-6 rounded-2xl bg-red-500/10 border border-red-500/20 max-w-md text-center">
            ...
            <p className="text-sm text-gray-400 mb-4">
              {this.props.fallbackMessage || 'İşlem sırasında bir sorun yaşandı. Lütfen tekrar deneyin.'}
            </p>
