  ...
  if ((categoryData?.length ?? 0) === 0 && (sentimentData?.length ?? 0) === 0) {
    return (
      <div className="p-8 rounded-xl glass text-center">
        <p className="text-gray-500 text-sm">No analysis data yet. Submit wishes with AI analysis to see charts.</p>
      </div>
    );
  }
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="p-5 rounded-xl glass">
        <h3 className="text-sm font-semibold mb-3">Wish Categories</h3>
        <div className="h-56">
